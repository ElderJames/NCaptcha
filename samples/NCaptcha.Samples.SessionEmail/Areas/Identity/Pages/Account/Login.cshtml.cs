...
namespace NCaptcha.Samples.SessionEmail.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task OnPostSendCaptchaAsync(string email)
        {
            await _captcha.GenerateCaptchaAsync();
        }
    }
}
